...
> **Audit (2026-09-13).** A re-analysis with positive controls and whole-brain screens is in [audit-2026-09-13.md](audit-2026-09-13.md): the recurrence-based exclusion of activity storage is withdrawn, the dopamine/octopamine coverage of the store candidates is corrected, hΔA→hΔI is a second inverter beside hΔM, PS196→GLNO is in print (Hulse 2023), and FB3A is multimodal. The compass brake is unchanged.

> **Final set (2026-09-12).** After the exhaustive pass and literature audit ([exhaustive-search.md](exhaustive-search.md)), four findings stand: (1) the compass brake, (2) synaptic storage of the home vector at hΔB→hΔ(H, A, I, G) with FB4M/FB1H dopamine and OA-VPM3, (3) hΔM as the only inverter and therefore the return path, (4) FB3A and PS196_b as velocity sources. Former findings on the LAL steering stage, PFR, MB bridges, oviIN and EL cue specificity were found to be largely in print and are kept as confirmations on the site. The numbered entries below are the historical working record.
