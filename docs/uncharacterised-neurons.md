...
- Hypothesis (corrected 2026-09-12): PFR is not an integrator. Anchored to Lyu 2022 (the hDeltaB travel bump is on the axon), the 195° hDeltaB input is the travel direction *non*-inverted, so PFR is a weighted sum of travel direction and heading-frame velocity, which is what Lyu 2022 imaged (PFR phase biased toward heading). The mismatch reading is withdrawn.
