...
_Written 17 September 2026, about 04:30. Campaign 2 ran from 20:15 to 04:00: 21 runs including restarts, starting from run 19 (1.62 at 30 s). Every number is the standard exam: seed 4242, 200 trips, 30-second wanders, with F allowed and with F held at zero._

## The answer to the question that was asked
The 30-second score did not go way down. The recipe that produced run 19 scores 1.72 on average over five seeds (1.62, 1.99, 1.61, 1.66, 1.73), and nothing tried tonight beat that average. The lowest single number of the night is 1.60 (run 28), inside the recipe's spread. If you want one honest sentence for the leaderboard: this network, trained this way, homes to about 1.7 units at 30 seconds, and we now know that to a spread of about 0.15.
...
2. **The count's direction is right; its length is not.** At the turn the decoded direction is off by 5 to 8 degrees and the length by about 0.9 units out of 6.9, biased short. Every knob left that number where it was.
...
7. **Optimisation is not the limit.** Batch 64, a low-rate polish, and both together improved the training-world fit and left the exam unchanged (runs 24, 26, 30, 31).
8. **Cold starts stall at 20 seconds.** Three of three tonight (128 neurons, the many-speeds world, the low erase floor), after one of two last night. Run 3's clean transfer looks like the fortunate case.
9. **The noise floor.** One recipe, five seeds, spread 0.15 with one draw at 1.99. Several first-night "improvements" of a tenth or two are inside this and should be read as ties.
