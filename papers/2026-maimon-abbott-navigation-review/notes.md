...
- **Memory frontier:** Figure 5 deliberately mixes hypotheses, preliminary cAMP imaging and schematic calcium spikes to propose that columnar populations could store vectors (a food location, a home vector) with tangential neurons gating which stored vector reaches FC2. The authors are explicit that fly evidence for vector memory is thin compared to ants and bees; Kim 2017, Behbahani 2021, Titova 2023 and D'Atri 2025 are the behavioral anchors, Chen 2024's scent-marking result the caution.
